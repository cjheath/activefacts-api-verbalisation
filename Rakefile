...
Jeweler::Tasks.new do |gem|
  ...
  gem.name = "activefacts-verbalisation"
  gem.homepage = "http://github.com/cjheath/activefacts-verbalisation"
  gem.license = "MIT"
  gem.summary = "A fact-based data model DSL and API"
  gem.description = %q{
ActiveFacts API Verbalisation provides verbalisation support for the activefacts-api
}
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title = "activefacts-verbalisation #{version}"
